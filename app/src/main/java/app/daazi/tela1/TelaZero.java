...
public class TelaZero extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaSignos = (ListView) findViewById(R.id.listView1Id);
...
/*
    ...
    protected void onListItemClick (ListView l, View v, int position, long id) {
        ...
        Toast.makeText(this, "usuario escolheu " + TELAS[position], Toast.LENGTH_LONG).show();
